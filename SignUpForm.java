...
public class SignUpForm extends HttpServlet {
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        writer.println("<body>");
        writer.println("<form action='/ssp/signUp' method='post' style='width:max-content;' class='mx-auto border mt-5 py-4 px-5'>");
        writer.println("<h6>Java Servlet Course</h6><h6>Sign Up!</h6>");
        writer.println("<div class='m-2'><div><label for='name'>Name</label></div><input type='text' name='name'/></div>");
        ...
        writer.println("<div class='m-2'><div><label for='password'>Confirm Password</label></div><input type='password' name='cnfpassword'/></div>");
        writer.println("<div class='m-2'><a style='color:black;' href='/ssp/signInForm'>Sign In ?</a></div>");
